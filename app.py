...
journals = [
    ...
    (3.1, "Applied Surface Science Advances - NOT RECOMMENDED, in ESCI index, not SCIE", "", 8.7, "OA Only", "Elsevier", "No"),
    ...
    (1.39, "Computational Condensed Matter - NOT RECOMMENDED, CURRENTLY in ESCI index, not SCIE", 16, 3.9, "NO", "Elsevier", "No"),
    ...
    (1.6, "Scientometrics", "", 3.5, "No", "Springer", "Yes"),
